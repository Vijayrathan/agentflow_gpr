...
A single agent interactively collects advanced/optional geometry parameters
from the user (buried objects, surface roughness, snapshots), validates against
the ExtractedAdvancedParams schema, and stores the result. The receiver array
now lives in the antenna section, and run settings (PML, threading, output
directory, fractal_nbins) live in the dataset_config section.
"""
